...
export const MODULE_NAV: { key: ModuleKey; href: string; num: string; labelKey: keyof Dictionary["nav"] }[] = [
  ...
  { key: "fleet", href: "/fleet", num: "05", labelKey: "fleet" },
  ...
  { key: "pumps", href: "/pumps", num: "11", labelKey: "pumps" },
  { key: "plants", href: "/plants", num: "12", labelKey: "plants" },
  { key: "billing", href: "/billing", num: "13", labelKey: "billing" },
  { key: "incentives", href: "/incentives", num: "14", labelKey: "incentives" },
  { key: "stockLedger", href: "/stock-ledger", num: "15", labelKey: "stockLedger" },
  { key: "users", href: "/users", num: "16", labelKey: "users" },
];
